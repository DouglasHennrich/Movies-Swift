...
class Logger {
    ...
    func info( _ args: CVarArg, function: String = #function, line: Int = #line, column: Int = #column ) {
    ...
    func error( _ args: CVarArg, function: String = #function, line: Int = #line, column: Int = #column ) {
        let message = getMessage(function, line, column, args)
        for destination in Logger.destinations {
    ...
    func warning( _ args: CVarArg, function: String = #function, line: Int = #line, column: Int = #column ) {
        let message = getMessage(function, line, column, args)
        for destination in Logger.destinations {
    ...
    func debug( _ args: CVarArg, function: String = #function, line: Int = #line, column: Int = #column ) {
        let message = getMessage(function, line, column, args)
        for destination in Logger.destinations {
